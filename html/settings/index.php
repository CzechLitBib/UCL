...
<table class="table my-4">
	...
	<td class="align-middle"><input type="text" class="form-control" id="exception-list" size="47" name="exception-list" value="<?php echo $exception_list;?>"></td>
	<td class="align-middle">
		<div class="row-3 mb-3">
	...
	<td class="align-middle">
		<div class="row-3 mb-3">
			<input type="submit" id="exception-display" name="exception-display" value="exception-display" hidden>
		...
		<div class="row-3 mt-3">
			<input type="submit" id="exception-export" name="exception-export" value="exception-export" hidden>
...
<table class="table my-4">
	...
	<td>
		...
		<label class="form-check-label" for="exampleRadios1">260/264a</label>
		</div>
		<div class="form-check">
		<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
		<label class="form-check-label" for="exampleRadios2">260/264b</label>
		</div>
		<div class="form-check">
		<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
		<label class="form-check-label" for="exampleRadios3">490a</label>
		</div>
		<div class="form-check">
		<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
		<label class="form-check-label" for="exampleRadios3">773t</label>
		</div>
		<div class="form-check">
		<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
		<label class="form-check-label" for="exampleRadios3">336</label>
		</div>
		<div class="form-check">
		<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
		<label class="form-check-label" for="exampleRadios3">337</label>
		</div>
		<div class="form-check">
		<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
		<label class="form-check-label" for="exampleRadios3">338</label>
		</div>
	</td>
	<td class="align-middle"><textarea class="form-control" id="dictionary-data" name="dictionary-data" rows="5">
</textarea></td>
	<td class="align-middle">
		<div class="row-3 mb-3">
			<input type="submit" id="code-save" name="code-save" value="code-save" hidden>

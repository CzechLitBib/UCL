...
if ($db) {
	$access = "SELECT * FROM module_group WHERE module = 'uclo' AND access_group = '" . $_SESSION['group'] . "';";
...
<nav class="navbar container-fluid navbar-expand-md navbar-dark" style="background-color:#dc3545;">
	<div class="row align-items-center gx-0">
		...
		<div class="col"><a class="navbar-brand nav-link active" href="/main/">Vývoj # UCLO</a></div>
	</div>
...
if (!empty($tags)) {
	...
	foreach ($tags as $tag)	{
		...
		if (!empty($has_seven)) {
			...
			. '<td><a href="/uclo/data.php?tag=' . $tag  . '&seven=1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bar-chart" viewBox="0 0 16 16"><path d="M4 11H2v3h2v-3zm5-4H7v7h2V7zm5-5v12h-2V2h2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1h-2zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3z"/></svg></a></td>'
			. '<td>' . $has_seven . '</td>'
			. '<td>' . round($has_seven/($has_seven + $has_no_seven)*100) . '%</td>';
		} else {
			echo '<tr><td class="align-middle"><b>' . $tag . '</b></td><td colspan="3"></td><td>0%</td>';
		}
		...
		if (!empty($has_no_seven)) {
			...
			. '<td><a href="/uclo/data.php?tag=' . $tag  . '&seven=0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bar-chart" viewBox="0 0 16 16"><path d="M4 11H2v3h2v-3zm5-4H7v7h2V7zm5-5v12h-2V2h2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1h-2zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3z"/></svg></a></td>'
			. '<td>' . $has_no_seven . '</td>'
	...
	echo '</tbody><tfoot><tr><th scope="col" colspan="3" class="text-start"><b>Celkem</b></td>'

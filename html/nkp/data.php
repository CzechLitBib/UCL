...
<nav class="navbar container-fluid navbar-expand-md navbar-dark" style="background-color:#dc3545;">
	<div class="row align-items-center gx-0">
		...
		<div class="col"><a class="navbar-brand nav-link active" href="/nkp/">Vývoj # NKP # <?php if (isset($_GET['tag'])) { echo $_GET['tag']; }?></a></div>
	</div>
...
if (!empty($_SESSION['nkp_month']) and !empty($_SESSION['nkp_year'])) {
	if (isset($_GET['tag']) and isset($_GET['seven']) and isset($_GET['new'])) {
		...
		$file = 'data/'	. $_SESSION['nkp_year'] . '/' . array_search($_SESSION['nkp_month'],$month_map) . '/' . $fn;

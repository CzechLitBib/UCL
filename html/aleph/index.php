...
$field = [
	...
	'505','506','520','524','594','599','600','610','611','630','648','650','651','653','655','663','664','665','667','670',
	'675','678','680','682','700','710','711','730','773','787','830','856','906','910','928','961','962','963','964','965',
	'966','967','990','994','995','OWN','CAT','IST','KAT','KON','POS','POZ','VER','SYS','SIF','STA','ZAZ','ZAR'
	)
];
...
<!-- Modal -->
<div class="modal" id="help" tabindex="-1" aria-labelledby="help" aria-hidden="true">
	...
	<div class="modal-body">
		...
		<h5>Rozhraní</h5>
		<p>Zaškrtávací políčka pod podmínkou určují jaké hodnoty budou součástí výstupu. Pole a&nbsp;podpole výstupu nemusí odpovídat polím a&nbsp;podpolím podmínky. Identifikátor záznamu se vkládá automaticky. Prázdná podmínka odpovídá všem hodnotám. Prázdné pole "počet řádků" odpovídá všem dostupným záznamům.</p> 
		<h5>Příklad</h5>

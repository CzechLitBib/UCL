...
if ($db) {
	$access = "SELECT * FROM module_group WHERE module = 'seven' AND access_group = '" . $_SESSION['group'] . "';";
...
<nav class="navbar container-fluid navbar-expand-md navbar-dark" style="background-color:#dc3545;">
	<div class="row align-items-center gx-0">
		...
		<div class="col"><a class="navbar-brand nav-link active" href="/seven/">Vývoj # 7 # <?php if (isset($_GET['tag'])) { echo $_GET['tag']; }?></a></div>
	</div>

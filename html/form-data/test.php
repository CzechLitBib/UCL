		...
		if (!$data->fetchArray()) {
			...
			while ($row = $data->fetchArray(SQLITE3_ASSOC)) {
				...
				echo '<div class="row px-1 d-flex align-items-center">';
					echo '<div class="col"><svg xmlns="http://www.w3.org/2000/svg" onclick="toggle_data(' . "'" .   $row['id'] . "'" . ')" width="24" height="24" fill="currentColor" class="bi bi-justify" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M2 12.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z"/></svg></div>';
					echo '<div class="col">' . date(" d.m Y H:i", hexdec(substr($row['id'],0,8))) . '</div>';# ID
					echo '<div class="col">' .$format_map[$row['format']] . '</div>';# FORMAT
					echo '<div class="col form-check form-switch"><input class="form-check-input" type="checkbox" role="switch"></div>';
				echo '</div>';
				echo '<hr class="m-1 p-0">';
				echo '</div>';
...
<nav class="mt-3" aria-label="Page navigation">
  <ul class="pagination justify-content-center">
	...
	<a class="page-link" href="#">Následujíci</a>
    </li>
  </ul>
</nav>

...
<nav class="navbar container-fluid navbar-expand-md navbar-dark" style="background-color:#dc3545;">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<a href="/logout.php" class="btn btn-sm mx-1 ms-auto btn-outline-light">Odhlasit</a>
...
<?php
	...
	if ($error) {
		...
		if ($count == 0) {
			...
			. '<th scope="col"></th><th scope="col"></th><th scope="col">zpracováno</th></tr></thead><tbody>';
			...
			while ($row = $data->fetchArray()) {
				...
				echo '<td class="px-md-2"><a href="download.php?id=' . $row[0] . '">'

 ...
 * Publisher indexing routines.
 */
public class CLB_PublisherTools
{
    /**
     ...
     */
    public Set<String> CLB_getPublishers(final Record record) {
        ...
        for (VariableField vf : list260)
        {
            ...
            if (currentString.length() > 0) {
                publishers.add(currentString.replaceAll(" ?,$", ""));
            }
        }
        ...
        for (VariableField vf : list264)
        {
            ...
            if (currentString.length() > 0) {
                ...
                {
                    case '1':
                        pubNames.add(currentString.replaceAll(" ?,$", ""));
                        break;
                    case '4':
                        copyNames.add(currentString.replaceAll(" ?,$", ""));
                        break;
                }
            }
        }

...
<head>
	...
	<title>ČLB Data - Formulář / Data</title>
...
<nav class="navbar container-fluid navbar-expand-md navbar-dark" style="background-color:#0e5f91;">
	<div class="row align-items-center gx-0">
		...
		<div class="col"><a class="navbar-brand nav-link active" href="/">Data # Formulář</a></div>
	</div>
                ...
                <div class="container-fluid">
                        <div class="row my-2">
                                ...
                                <div class="col-3 d-flex align-items-center">
                                        <button class="btn btn-sm w-100 text-light" style="background-color:#0e5f91;" onclick="on_confirm()">Ano</button>
                                </div>

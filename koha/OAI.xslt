                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li>
                                    <a title="Listing records (with metadata)">
                                        ...
                                        <xsl:attribute name="href">
                                            <xsl:value-of
                                                    select="concat($oai_script_name, '?verb=ListRecords&amp;metadataPrefix=marcxml')"></xsl:value-of>
                                        </xsl:attribute>
                                        Records
                                    </a>
                                </li>
                                <li>
                                    <a title="Listing identifiers only">
                                        ...
                                        <xsl:attribute name="href">
                                            <xsl:value-of
						    select="concat($oai_script_name, '?verb=ListIdentifiers&amp;metadataPrefix=marcxml')"></xsl:value-of>
                                        </xsl:attribute>
                                        Identifiers
                                    </a>
                                </li>
                ...
                <div class="list-group-item">
                    ...
                    <div class="spec">
                        <a>
                            <xsl:attribute name="href">
                                <xsl:value-of
                                        select="concat($oai_script_name, '?verb=ListRecords&amp;metadataPrefix=marcxml&amp;set=', oai:setSpec/text())" />
                            </xsl:attribute>
                            Records
                        </a>
                        <a>
                            <xsl:attribute name="href">
                                <xsl:value-of
                                        select="concat($oai_script_name, '?verb=ListIdentifiers&amp;metadataPrefix=marcxml&amp;set=', oai:setSpec/text())" />
                            </xsl:attribute>
                            Identifiers
                        </a>
                    </div>
                                ...
                                <xsl:for-each select="oai:header/oai:setSpec">
                                    <div class="list-group-item">
                                        <a>
                                            <xsl:attribute name="href">
                                                <xsl:value-of
                                                        select="concat($oai_script_name, '?verb=ListRecords&amp;metadataPrefix=marcxml&amp;set=', text())" />
                                            </xsl:attribute>
                                            <xsl:value-of select="text()" />
                                        </a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <a class="btn btn-default pull-right">
                                <xsl:attribute name="href">
                                    <xsl:value-of select="concat($oai_script_name, '?verb=GetRecord&amp;metadataPrefix=marcxml&amp;identifier=', oai:identifier/text())" />
                                </xsl:attribute>
                                View Details
                            </a>
                        </div>
